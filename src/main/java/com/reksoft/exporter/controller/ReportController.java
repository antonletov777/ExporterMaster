...
import com.reksoft.exporter.service.player.PlayerCsvReportService;
import com.reksoft.exporter.service.team.TeamCsvReportService;
...
public class ReportController {
    ...
    private final TeamCsvReportService teamService;
    ...
    public ResponseEntity<Resource> downloadTeamReport() throws IOException {
        String timestamp = LocalDateTime.now(clock).format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"));
        String filename = "player_report_%s.csv".formatted(timestamp);
        File reportFile = teamService.generateReport(System.getProperty("java.io.tmpdir") + File.separator + filename);
